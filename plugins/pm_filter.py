    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                z = await message.reply_photo(photo="https://telegra.ph/file/acb82cc515d027857a0f7.jpg", caption=f"<b>HI {message.from_user.mention} Read this Point's, \n•ചിലപ്പോൾ നിങ്ങൾ അയച്ച സ്പെല്ലിങ് തെറ്റ് ആകാം../n•നിങ്ങൾ ചോദിച്ച മൂവി OTT oR DVD റിലീസ് ആയി കാണില്ല./n•google നോക്കി ശെരിയായ സ്പെല്ലിങ് മാത്രം കോപ്പി ചെയ്ത് അയക്കുക./n•നിങ്ങൾ ചോദിച്ച ഫയൽ എന്റെ ഡാറ്റബേസിൽ കാണില്ല./n•ഇംഗ്ലീഷ് ലാംഗ്വേജ് മാത്രമേ എനിക്ക് മനസ്സിലാകൂ അതിനാൽ ഇംഗിഷ് മാത്രം ഉപയോഗിക്കുക./n📍ഇതിൽ ഏതെങ്കിലും കാരണം കൊണ്ട് ആക്കാം നിങ്ങൾക്ക് ഫയൽ കിട്ടാത്തത്.</b>", reply_markup = InlineKeyboardMarkup(buttons))   

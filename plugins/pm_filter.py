...
from info import ADMINS, AUTH_CHANNEL, FILE_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, NOR_IMG, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, SPELL_IMG, MSG_ALRT, FILE_FORWARD, MAIN_CHANNEL, LOG_CHANNEL, PICS, SUPPORT_CHAT_ID, CHECK_IMG
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            if not files: 
                cap = text=f"<b><i>{message.from_user.mention} അതേ നിങ്ങൾ അയച്ച സ്പെല്ലിങ് തെറ്റ് ആണ്. ഗൂഗിൾ നോക്കി ഒന്നും കൂടി മൂവി നെയിം അയക്കുക. നിങ്ങൾ ചോദിച്ച മൂവി OTT റിലീസ് ആയെങ്കിൽ ഞാൻ ഫയൽ തരും.\n🎀എന്നിട്ടും മൂവി കിട്ടുന്നില്ല എങ്കിൽ OTT, DVD ലും മൂവി റിലീസ് ആയികാണില്ല.</i>\n\n𝘠𝘦𝘴, 𝘵𝘩𝘦 𝘴𝘱𝘦𝘭𝘭𝘪𝘯𝘨 𝘺𝘰𝘶 𝘴𝘦𝘯𝘵 𝘪𝘴 𝘪𝘯𝘤𝘰𝘳𝘳𝘦𝘤𝘵. 𝘑𝘶𝘴𝘵 𝘴𝘦𝘢𝘳𝘤𝘩 𝘎𝘰𝘰𝘨𝘭𝘦 𝘢𝘯𝘥 𝘴𝘦𝘯𝘥 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘯𝘢𝘮𝘦. 𝘐𝘧 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘺𝘰𝘶 𝘢𝘴𝘬𝘦𝘥 𝘧𝘰𝘳 𝘪𝘴 𝘢𝘯 𝘖𝘛𝘛 𝘳𝘦𝘭𝘦𝘢𝘴𝘦, 𝘐 𝘸𝘪𝘭𝘭 𝘱𝘳𝘰𝘷𝘪𝘥𝘦 𝘵𝘩𝘦 𝘧𝘪𝘭𝘦.\n🎀𝘚𝘵𝘪𝘭𝘭 𝘪𝘧 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘪𝘴 𝘯𝘰𝘵 𝘢𝘷𝘢𝘪𝘭𝘢𝘣𝘭𝘦 𝘵𝘩𝘦𝘯 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘸𝘪𝘭𝘭 𝘯𝘰𝘵 𝘣𝘦 𝘳𝘦𝘭𝘦𝘢𝘴𝘦𝘥 𝘰𝘯 𝘖𝘛𝘛 𝘢𝘯𝘥 𝘋𝘝𝘋.\n\n<i>✺അല്ലെങ്കിൽ നിങ്ങൾ അയച്ച അക്ഷരം ഇംഗ്ലീഷ് ആകില്ല ചിലപ്പോൾ fancy font ആകാം അതിനാൽ ആകും നിങ്ങൾക്ക് ഫയൽ കിട്ടാത്തത്.\n✺ദയവുചെയ്ത് തിയേറ്ററിൽ ഓടുന്ന മൂവി റിക്വസ്റ്റ് ചെയ്യല്ലേ.. കിട്ടില്ല.\n\n✺Or the letter you sent may not be English, sometimes it may be fancy font, so you may not get the file.\n✺ Please don't request the movie that is playing in the theater.. I can't get it.</i></b>"            
                buttons = [[ InlineKeyboardButton(text="check googel", url='https://www.google.com/search?q=') ]]
                z = await message.reply_photo(photo=CHECK_IMG', caption=cap[:1024] text=f"<b><i>{message.from_user.mention} അതേ നിങ്ങൾ അയച്ച സ്പെല്ലിങ് തെറ്റ് ആണ്. ഗൂഗിൾ നോക്കി ഒന്നും കൂടി മൂവി നെയിം അയക്കുക. നിങ്ങൾ ചോദിച്ച മൂവി OTT റിലീസ് ആയെങ്കിൽ ഞാൻ ഫയൽ തരും.\n🎀എന്നിട്ടും മൂവി കിട്ടുന്നില്ല എങ്കിൽ OTT, DVD ലും മൂവി റിലീസ് ആയികാണില്ല.</i>\n\n𝘠𝘦𝘴, 𝘵𝘩𝘦 𝘴𝘱𝘦𝘭𝘭𝘪𝘯𝘨 𝘺𝘰𝘶 𝘴𝘦𝘯𝘵 𝘪𝘴 𝘪𝘯𝘤𝘰𝘳𝘳𝘦𝘤𝘵. 𝘑𝘶𝘴𝘵 𝘴𝘦𝘢𝘳𝘤𝘩 𝘎𝘰𝘰𝘨𝘭𝘦 𝘢𝘯𝘥 𝘴𝘦𝘯𝘥 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘯𝘢𝘮𝘦. 𝘐𝘧 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘺𝘰𝘶 𝘢𝘴𝘬𝘦𝘥 𝘧𝘰𝘳 𝘪𝘴 𝘢𝘯 𝘖𝘛𝘛 𝘳𝘦𝘭𝘦𝘢𝘴𝘦, 𝘐 𝘸𝘪𝘭𝘭 𝘱𝘳𝘰𝘷𝘪𝘥𝘦 𝘵𝘩𝘦 𝘧𝘪𝘭𝘦.\n🎀𝘚𝘵𝘪𝘭𝘭 𝘪𝘧 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘪𝘴 𝘯𝘰𝘵 𝘢𝘷𝘢𝘪𝘭𝘢𝘣𝘭𝘦 𝘵𝘩𝘦𝘯 𝘵𝘩𝘦 𝘮𝘰𝘷𝘪𝘦 𝘸𝘪𝘭𝘭 𝘯𝘰𝘵 𝘣𝘦 𝘳𝘦𝘭𝘦𝘢𝘴𝘦𝘥 𝘰𝘯 𝘖𝘛𝘛 𝘢𝘯𝘥 𝘋𝘝𝘋.\n\n<i>✺അല്ലെങ്കിൽ നിങ്ങൾ അയച്ച അക്ഷരം ഇംഗ്ലീഷ് ആകില്ല ചിലപ്പോൾ fancy font ആകാം അതിനാൽ ആകും നിങ്ങൾക്ക് ഫയൽ കിട്ടാത്തത്.\n✺ദയവുചെയ്ത് തിയേറ്ററിൽ ഓടുന്ന മൂവി റിക്വസ്റ്റ് ചെയ്യല്ലേ.. കിട്ടില്ല.\n\n✺Or the letter you sent may not be English, sometimes it may be fancy font, so you may not get the file.\n✺ Please don't request the movie that is playing in the theater.. I can't get it.</i></b>", reply_markup=InlineKeyboardMarkup(buttons))

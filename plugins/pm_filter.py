    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                z = await message.reply_text(f"<i>{message.from_user.mention}🪛I don't have a file in the word you sent, sometimes the word you sent is wrong.If this movie is an OTT release please check the spelling and then send it.</i>", reply_markup=types.InlineKeyboardMarkup(buttons))             
